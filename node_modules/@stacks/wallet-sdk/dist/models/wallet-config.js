...
const getOrCreateWalletConfig = async ({ wallet, gaiaHubConfig, skipUpload, fetchFn = (0, common_1.createFetchFn)(), }) => {
...
const fetchWalletConfig = async ({ wallet, gaiaHubConfig, fetchFn = (0, common_1.createFetchFn)(), }) => {
    try {
