...
async function restoreWalletAccounts({ wallet, gaiaHubUrl, network = 'mainnet', client: _client, }) {
    ...
    const hubInfo = await (0, utils_1.getHubInfo)(gaiaHubUrl, client.fetch);
    ...
    const [walletConfig, legacyWalletConfig] = await Promise.all([
        (0, wallet_config_1.fetchWalletConfig)({ wallet, gaiaHubConfig: currentGaiaConfig, fetchFn: client.fetch }),
        (0, legacy_wallet_config_1.fetchLegacyWalletConfig)({ wallet, gaiaHubConfig: legacyGaiaConfig, fetchFn: client.fetch }),
    ]);
    if (walletConfig &&
